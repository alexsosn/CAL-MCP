...
- text catalogue/topic discovery, one-page retrieval (paginated texts such as the Babylonian Talmud report page, page count and line total; a page beyond the last is an `invalid_input` error), explicit text-information metadata, and explicit line comments/translations via `cal_text_line_comments`;
