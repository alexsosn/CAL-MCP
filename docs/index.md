...
| Online text discovery, topic search, explicit text-information metadata, and bounded page reading | **Implemented** | [`cal_text_catalogue`, `cal_text_search`, `cal_text_information`, `cal_text_page`](tools/texts.md) |
