...
MCP clients should use the server's executable tool schemas rather than relying on hand-maintained parameter lists. The v0.1 surface contains 34 public tools grouped in the [user documentation index](../index.md).
