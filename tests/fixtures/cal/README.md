...
| `text_page_ginza_right_001_current.html` | `https://cal.huc.edu/get_a_chapter.php?cset=M&file=74410&sub=001` (2026-09-25) | current Mandaic subdivided page: file-info `coord` carries the private `sub` page selector; first 2 of 24 rows |
