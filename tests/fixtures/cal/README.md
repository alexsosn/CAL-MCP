...
| `text_page_blank_word0_60424_current.html` | exact blank row retained from `https://cal.huc.edu/get_a_chapter.php?file=60424&page=0` (2026-09-25), inside a clearly marked synthetic file-info shell | current Ephrem blank-line sentinel: one empty `getlex.php` anchor at `word=0&hasvariant=0` |\n| `text_page_philemon_62057_current.html` | `https://cal.huc.edu/get_a_chapter.php?file=62057&page=0` (2026-09-25) | current table row whose coordinate cell carries CAL's "[ai]" Ask-AI link after the display coordinate; first 2 of 25 rows |
